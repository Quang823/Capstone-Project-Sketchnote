...
import getStyles from "./BankAccountsScreen.styles";
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.deleteModalContent}>
            ...
            <View style={styles.deleteModalBody}>
              ...
              {deletingAccount && (
                <View style={styles.deleteModalAccountInfo}>
                  <Text style={styles.deleteModalAccountName}>
                    {deletingAccount.branch} - {deletingAccount.bankName}
                  </Text>
                  <Text style={styles.deleteModalAccountNumber}>
